...
import { ArrowRight, Package, AlertTriangle, Activity } from 'lucide-react'
...
export default async function SearchPage({ searchParams }: SearchPageProps) {
    ...
    const hasResults = results.shipments.length > 0 || results.alerts.length > 0 || results.activities.length > 0
        ...
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                ...
                <p className="text-sm text-gray-500">
                    {results.shipments.length + results.alerts.length + results.activities.length} results found
                </p>
            </div>
